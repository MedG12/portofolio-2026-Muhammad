      ...
      <div className="container">
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              <a href="https://www.linkedin.com/in/mhmmmd" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--shade-40)', textDecoration: 'none', fontSize: '14px', transition: 'color 0.2s' }} onMouseOver={e => e.currentTarget.style.color = 'var(--on-primary)'} onMouseOut={e => e.currentTarget.style.color = 'var(--shade-40)'}>LinkedIn</a>
